...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    <div
        class="origin-top-right z-10 absolute top-full min-w-56 bg-white dark:bg-slate-200 dark:border-slate-300 border border-slate-200 pt-1.5 rounded shadow-lg overflow-hidden mt-1 {{$align === 'right' ? 'right-0' : 'left-0'}}"                
