...
<div x-data="{ searchOpen: false }">
    ...
    >
        <div
            class="bg-white dark:bg-slate-200 dark:border-slate-300 overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg"
        ...
        >   
            ...
            <form class="border-b border-slate-200">
                <div class="relative">
                    ...
                    <input id="modal-search" class="w-full border-0 focus:ring-transparent placeholder-slate-400 appearance-none py-3 pl-10 pr-4 dark:bg-slate-500 dark:border-slate-300" type="search" placeholder="Search Anything…" x-ref="searchInput" />
