<div wire:init='loadContent'>
    <div class="flex items-center justify-between pb-4  bg-slate-100 dark:bg-gray-800">
        <div class="flex items-center">
            ...
            <select wire:model='cant'
                class="mx-2 p-2 pr-8 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    @if ($units == 'spin')
        <div
            class="relative items-center block  bg-white border border-gray-100 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-800 dark:hover:bg-gray-700">
                    ...
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="cursor-pointer px-6 py-3"
                                wire:click="order('email_verified_at')">
                                Siglas
                                @if ($sort == 'acronym')
                                    @if ($direction == 'asc')
                                        <i class="fas fa-sort-alpha-up-alt float-right mt-1"></i>
    ...
    <x-jet-dialog-modal wire:model="open_edit">
        ...
        <x-slot name="content">
            <div class="mb-4">
                ...
                <x-jet-input type="text" wire:model="unit.name" />
                <x-jet-input-error for="unit.name" />
            </div>
            <div class="mb-4">
                <x-jet-label value="Siglas" />
                <x-jet-input type="text" wire:model="unit.acronym" />
                <x-jet-input-error for="unit.acronym" />
            </div>
            <div class="mb-4">
                <x-jet-label value="Dirección" />
                <textarea class="form-input w-full" name="" id="" cols="20" rows="2"wire:model="unit.address">
                </textarea>
                <x-jet-input-error for="unit.address" />
            </div>
        </x-slot>
    ...
    <script src="sweetalert2.all.min.js"></script>
     <script>
        Livewire.on('deleteUnit', unit => {
            Swal.fire({
                title: '¿Confirmas esta acción?',
                text: "¡Si la confirmas eliminaras la Unidad " +unit['name']+ " !",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    Livewire.emitTo('unit.show-units','delete',unit);

                    Swal.fire(
                    '¡Eliminada!',
                    "La unidad " + unit['name'] + " fue eliminada.",
                    'success'
                    )
                }
            })
